...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/safeminecoin/safeminex>";
    const std::string URL_WEBSITE = "<https://www.safeminecoin.xyz>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    connman.AddNode("addnode=192.99.252.243");
    connman.AddNode("addnode=135.125.225.55");
    connman.AddNode("addnode=51.195.249.132");
