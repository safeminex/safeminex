...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s safeminex-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  safeminex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded safeminex transaction") + "\n" +
              "  safeminex-tx [options] -create [commands]   " + _("Create hex-encoded safeminex transaction") + "\n" +
              "\n";
