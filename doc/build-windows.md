...
Below are some notes on how to build SafeMineX Core for Windows.
...
way. This will install to `c:\local\safeminex`, for example:

    make install DESTDIR=/mnt/c/local/safeminex
